...
class ServiceSeeder extends Seeder
{
    ...
    private function data()
    {
        return [
            ...
            ['id' => 2, 'service_type_id' => 11, 'service_vendor_id' => 1, 'service_name' => 'PAy Now', 'service_slug' => 'pay_now', 'logo_svg' => null, 'logo_png' => null, 'service_notification' => 'yes', 'service_delay' => 'yes', 'service_stat_policy' => 'yes', 'service_serial' => 1, 'service_data' => ['visible_website' => 'yes', 'visible_android_app' => 'yes', 'visible_ios_app' => 'yes', 'account_name' => null, 'account_number' => null, 'transactional_currency' => 'BDT', 'beneficiary_type_id' => null, 'operator_short_code' => null], 'enabled' => true],
            ['id' => 3, 'service_type_id' => 12, 'service_vendor_id' => 1, 'service_name' => 'E-nets', 'service_slug' => 'e_nets', 'logo_svg' => null, 'logo_png' => null, 'service_notification' => 'yes', 'service_delay' => 'yes', 'service_stat_policy' => 'yes', 'service_serial' => 1, 'service_data' => ['visible_website' => 'yes', 'visible_android_app' => 'yes', 'visible_ios_app' => 'yes', 'account_name' => null, 'account_number' => null, 'transactional_currency' => 'BDT', 'beneficiary_type_id' => null, 'operator_short_code' => null], 'enabled' => true],
            ['id' => 4, 'service_type_id' => 13, 'service_vendor_id' => 1, 'service_name' => 'Wallet to Wallet Transfer', 'service_slug' => 'fund_Rising', 'logo_svg' => null, 'logo_png' => null, 'service_notification' => 'yes', 'service_delay' => 'yes', 'service_stat_policy' => 'yes', 'service_serial' => 1, 'service_data' => ['visible_website' => 'yes', 'visible_android_app' => 'yes', 'visible_ios_app' => 'yes', 'account_name' => null, 'account_number' => null, 'transactional_currency' => 'BDT', 'beneficiary_type_id' => null, 'operator_short_code' => null], 'enabled' => true],
        ];
    }
}
